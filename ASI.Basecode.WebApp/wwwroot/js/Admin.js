...
const deleteModalContainer = document.querySelector(
  "[data-admin-delete-modal-container]"
);
...
const adminEditCancelBtn = document.querySelector(
  "[data-admin-edit-cancel-btn]"
);
...
const adminDelCloseBtn = document.querySelector(
  "[data-admin-delete-close-btn]"
);
const adminDelCancelBtn = document.querySelector(
  "[data-admin-delete-cancel-btn]"
);
