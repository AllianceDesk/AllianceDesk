...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => new { e.UserId, e.ArticleId }, "UQ__Favorite__A57D58682EA8B426")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => new { e.RecipientId, e.TicketId }, "UQ__Notifica__57532FB0903CEA7B")
                    .IsUnique();
            ...
            modelBuilder.Entity<TicketActivity>(entity =>
            {
                entity.HasKey(e => e.HistoryId)
                    .HasName("PK__TicketAc__096AA2E92850D393");
            ...
            modelBuilder.Entity<TicketActivityOperation>(entity =>
            {
                entity.HasKey(e => e.OperationId)
                    .HasName("PK__TicketAc__9DE17123894FE964");
            ...
            modelBuilder.Entity<TicketMessage>(entity =>
            {
                entity.HasKey(e => e.MessageId)
                    .HasName("PK__TicketMe__0BBF6EE62ABFEC3B");
            ...
            modelBuilder.Entity<TicketPriority>(entity =>
            {
                entity.HasKey(e => e.PriorityId)
                    .HasName("PK__TicketPr__EE325785AF31F987");
            ...
            modelBuilder.Entity<TicketStatus>(entity =>
            {
                entity.HasKey(e => e.StatusId)
                    .HasName("PK__TicketSt__3683B5316E9BB3D6");
            ...
            modelBuilder.Entity<UserPreference>(entity =>
            {
                entity.HasKey(e => e.PreferenceId)
                    .HasName("PK__UserPref__FB41DBCF4DAC2612");
            ...
            modelBuilder.Entity<UserRole>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__UserRole__760965CC82BB1BEF");
